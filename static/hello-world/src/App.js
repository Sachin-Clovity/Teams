...
export default function App() {
  ...
  return (
    <div style={s.wrap}>
      ...
      <div style={s.sub}>Route Jira issue events to a Teams channel via Microsoft Graph API.</div>
      ...
      {!connected ? (
        ...
        <>
          ...
          <button
            style={(!teamId || !channelId || loading) ? s.btnGrey : s.btnBlue}
            onClick={save} disabled={!teamId || !channelId || loading}
          >
